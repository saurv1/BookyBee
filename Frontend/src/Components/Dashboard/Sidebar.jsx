...
const Sidebar = ({ role, userName, hasUnreadMessages, profilePicture, isOpen, setIsOpen }) => {
    ...
    return (
        <>
            ...
            <div className={`fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-100 flex flex-col z-50 transition-transform duration-300 ease-in-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                {/* Logo & Close Button */}
                ...
                <div className="p-4 border-t border-gray-50 mt-auto bg-gray-50/30">
                    <Link to="/profile" onClick={() => setIsOpen(false)} className="flex items-center space-x-3 mb-4 p-2 hover:bg-gray-100/50 rounded-xl transition-colors group">
