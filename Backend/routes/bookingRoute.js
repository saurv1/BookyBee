...
const { createBooking, getCustomerBookings, getCustomerStats, getAdminStats, getProviderStats, rateBooking, updateBookingStatus, getProviderBookings } = require('../controllers/bookingController');
